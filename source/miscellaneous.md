...
the value of `PARAMETER` for a given parameter in the set will be the value of that parameter
and thus can be different for different parameters in the set.
