...
```{image} _static/pals-logo-light.png
:alt: PALS logo, dark ink variant, for use on light backgrounds
:class: logo-on-light
:width: 90%
```
...
```{image} _static/pals-logo-dark.png
:alt: PALS logo, light ink variant, for use on dark backgrounds
:class: logo-on-dark
:width: 90%
```
